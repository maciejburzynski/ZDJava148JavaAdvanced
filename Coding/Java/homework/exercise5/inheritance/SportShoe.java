...
public class SportShoe extends Shoe {
    ...
    private homework.exercise5.inheritance.SportType sportType;
    ...
    public homework.exercise5.inheritance.SportType getSportType() {
        return sportType;
    }

    public void setSportType(homework.exercise5.inheritance.SportType sportType) {
        this.sportType = sportType;
    }
